...
package com.qlj.lakinqiandemo.threadpool;
...
public class ThreadPool {
    ...
    private static int corePoolSize = Math.max(2, Math.min(CPU_COUNT - 1, 4));
    ...
    ResourceCounter mCpuCounter = new ResourceCounter(corePoolSize);
