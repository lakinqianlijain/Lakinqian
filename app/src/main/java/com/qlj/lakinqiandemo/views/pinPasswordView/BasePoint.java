...
public abstract class BasePoint {
	...
	public BasePoint(Context context, int leftX, int rightX, int topY, int bottomY,
	...
	abstract void setStateWrong();

	abstract void setStateSelected();

	abstract void setStateNormal();
}
